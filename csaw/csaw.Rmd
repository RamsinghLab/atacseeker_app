...
plot(0:n, pe.corr, col="blue", ylim=c(0, 0.1), xlim=c(0, 1000), xlab="Delay (bp)", ylab="CCF", pch=16, type="l", lwd=2) 
```
...
legend("topright", col=c("blue", "forestgreen", rgb(0,0,0,0.5)), c("normal1_sorted_filtered", "normal2_sorted_filtered", 
                  "normal4_sorted_filtered", "senescent1_sorted_filtered", 
                  "senescent2_sorted_filtered", "senescent4_sorted_filtered.bam"), pch=16)
